...
object FrontdeskHttpRequests {
  ...
  def searchPatientUsingName(loginLocationUuid: String, identifier: String): HttpRequestBuilder = {
    http("Search Patient by Name")
      .get("/openmrs/ws/rest/v1/bahmni/search/patient")
      ...
      .queryParam("patientAttributes", "mobilePhone")
      .queryParam("patientAttributes", "residencePhone")
      .queryParam("patientAttributes", "workPhone")
      .queryParam("patientAttributes", "otherPhone")
      .queryParam("patientSearchResultsConfig", "mobilePhone")
      .queryParam("patientSearchResultsConfig", "residencePhone")
      .queryParam("patientSearchResultsConfig", "workPhone")
      .queryParam("patientSearchResultsConfig", "otherPhone")
  ...
  def searchPatientUsingIdentifier(loginLocationUuid: String, identifier: String): HttpRequestBuilder = {
    http("Search Patient by Identifier")
      .get("/openmrs/ws/rest/v1/bahmni/search/patient/lucene")
      .queryParam("addressFieldName","address2")
      .queryParam("addressSearchResultsConfig","address2")

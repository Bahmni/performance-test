...
object Consultation {
  ...
  val setRate = {
    ...
    var actualPace: FiniteDuration = Duration(((trafficConfig.duration * (CONSULTATION_LOAD_SHARE/100.00 * trafficConfig.activeUsers)) / (0.27*trafficConfig.patients)).toSeconds,SECONDS)
